...
from snowbase.config import SessionMaker
from snowbase.utils import import_class, env_str
from snowbase.model import DuplicateAnomaly


class EntryPoint:

    """EntryPoint class define as access point
    for the class in :py:class:`snowbase.model` file.
    ...
    def __init__(self):
        ...
        self.db = import_class(
            f"{env_str('DB_CLASS', default='snowbase.model.Package')}"
        )
    ...
    def create_table(self):
        ...
        .. note::
            * add filter function.
        """
        from snowbase.config import Base, engine
